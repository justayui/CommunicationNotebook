...
class NoteControllerTest {
    ...
    void findAll_returnsNoteListWithFavoritedField() {
        NoteResponse note = new NoteResponse(
                1, 1, "雑談", "これはテスト投稿です。", "テスト太郎", LocalDateTime.of(2026, 8, 30, 10, 0), true);
    ...
    void create_returnsCreatedNote() {
        NoteResponse note = new NoteResponse(
                1, 1, "雑談", "これはテスト投稿です。", "テスト太郎", LocalDateTime.of(2026, 8, 30, 10, 0), false);
    ...
    void update_returnsUpdatedNote() {
        NoteResponse note = new NoteResponse(
                1, 1, "業務連絡", "更新後の内容", "テスト太郎", LocalDateTime.of(2026, 8, 30, 10, 0), false);
